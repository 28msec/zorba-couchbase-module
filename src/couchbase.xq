...
(:~
 ...
 :
 :)  
declare function cb:store($key as xs:string, $value as xs:string)
    as empty-sequence() external;
...
(:~
 ...
 :)
declare function cb:get($key as xs:string*)
...
(:~
 ...
 :
 :)
declare function cb:remove($key as xs:string)
    as empty-sequence() external;
